# FpsBoost-ToolKit
A one-click performance optimization tool designed for both low-end and high-end.   This toolkit boosts FPS, reduces memory usage, clears RAM/cache, and automatically configures performance tools like:
